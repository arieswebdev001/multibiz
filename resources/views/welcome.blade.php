...
<html lang="en">
    ...
    <head>
        ...
        <link href="../theme/layouts/layout4/css/themes/default.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <link href="../theme/layouts/layout4/css/custom.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-container-bg-solid page-header-fixed  page-sidebar-fixed page-sidebar-closed-hide-logo page-md">
        <div id="app"></div>
        <!-- END QUICK NAV -->
        <!--[if lt IE 9]>
